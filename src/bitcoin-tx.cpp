...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bigcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bigcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bigcoin transaction") + "\n" +
              "  bigcoin-tx [options] -create [commands]   " + _("Create hex-encoded bigcoin transaction") + "\n" +
              "\n";
