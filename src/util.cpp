...
const char * const BITCOIN_CONF_FILENAME = "bigcoin.conf";
const char * const BITCOIN_PID_FILENAME = "bigcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bigcoin";
#else
    // Unix
