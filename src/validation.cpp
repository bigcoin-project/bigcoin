...
#if defined(NDEBUG)
# error "Bigcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Bigcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s BGC additional fees, %d delta bytes\n",
