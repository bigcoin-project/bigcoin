...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.bigcoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.bigcointools.com", true);
        vSeeds.emplace_back("dnsseed.bigcoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.bigcointools.com", true);
        vSeeds.emplace_back("seed-b.bigcoin.loshan.co.uk", true);
